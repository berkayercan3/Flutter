...
class _MyCollectionsDemoState extends State<MyCollectionsDemo> {
  ...
  void initState() {
    super.initState();
    _items = CollectionsItem()
        .items; // başlangıçta ekranda görünecek ögeleri belirledik
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView.builder(
          //bir liste oluşturdu bu listemiz cardlardan oluşuyor
          itemCount: _items
              .length, // 4 tane card ımız var o kadar sayfa görünecek bu olmasa sonsuza giderdi ve hata alıdık
...
class CollectionsItem {
  ...
  CollectionsItem() {
    items = [
      CollectionModel(
          imagePath: Images.imageone, title: 'Abstract Art', price: 3.4),
      CollectionModel(
          imagePath: Images.imagetwo, title: 'Abstract Art1', price: 3.4),
      CollectionModel(
          imagePath: Images.imageone, title: 'Abstract Art2', price: 3.4),
      CollectionModel(
          imagePath: Images.imagetwo, title: 'Abstract Art3', price: 3.4),
    ];
  }
}
